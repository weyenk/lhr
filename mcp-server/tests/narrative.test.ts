...
describe('generateNarrative', () => {
  it('returns the trimmed LLM narrative on success', async () => {
    callLLM.mockResolvedValue('  Once upon a weeknight, dinner needed to be easy.  ');
